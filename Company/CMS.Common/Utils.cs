...
namespace CMS.Common
{
    public class Utils
    {
        ...
        public static string OutPageListFix(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            //计算页数
            if (totalCount < 1 || pageSize < 1)
            {
            ...
            StringBuilder pageStr = new StringBuilder();
            string pageId = "__id__";
            string firstBtn = "<li><a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex - 1).ToString()) + "\"><i class=\"fa fa-angle-left\"></i></a></li>";
            string lastBtn = "<li><a href=\"" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "\"><i class=\"fa fa-angle-right\"></i></a></li>";
            string firstStr = "<li><a href=\"" + ReplaceStr(linkUrl, pageId, "1") + "\">1</a></li>";
            string lastStr = "<li><a href=\"" + ReplaceStr(linkUrl, pageId, pageCount.ToString()) + "\">" + pageCount.ToString() + "</a></li>";

            if (pageIndex <= 1)
            {
                firstBtn = "<li class=\"disabled\"><a href=\"javascript:;\"><i class=\"fa fa-angle-left\"></i></a></li>";
            }
            if (pageIndex >= pageCount)
            {
                lastBtn = "<li class=\"disabled\"><a href=\"javascript:;\"><i class=\"fa fa-angle-right\"></i></a></li>";
            }
            if (pageIndex == 1)
            {
                firstStr = "<li class=\"active\"><a href=\"javascript:;\">1<span class=\"current sr-only\">1</span></a></li>";
            }
            if (pageIndex == pageCount)
            {
                lastStr = "<li class=\"active\"><a href=\"javascript:;\">" + pageCount.ToString() + "<span class=\"current sr-only\">" + pageCount.ToString() + "</span></a></li>";
            }
            int firstNum = pageIndex - (centSize / 2); //中间开始的页码
            if (pageIndex < centSize)
                firstNum = 2;
            ...
            for (int i = firstNum; i <= lastNum; i++)
            {
                if (i == pageIndex)
                {
                    pageStr.Append("<li class=\"active\"><a href=\"javascript:;\">" + i + "<span class=\"current sr-only\">" + i + "</span></a></li>");
                }
                else
                {
