<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="CMS.Web.admin.users.message_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="message_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>发送消息</span></a></li>
