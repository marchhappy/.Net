<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_list.aspx.cs" Inherits="CMS.Web.admin.users.oauth_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="folder" href="oauth_app_list.aspx"><i></i><span>OAuth设置</span></a></li>
