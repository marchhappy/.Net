<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="CMS.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new CMS.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
