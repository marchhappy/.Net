...
namespace CMS.Web.admin.users
{
    public partial class oauth_app_list : Web.UI.ManagePage
    {
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("oauth_app_list_page_size", "CMSPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        #region 返回设备支持=============================
        protected string GetOauthType(string oauthType)
        {
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("oauth_app_list_page_size", "CMSPage", _pagesize.ToString(), 14400);
                }
            }
