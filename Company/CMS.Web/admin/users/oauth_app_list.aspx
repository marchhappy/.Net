<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_app_list.aspx.cs" Inherits="CMS.Web.admin.users.oauth_app_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="oauth_app_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="10%">设备支持</th>
    <th align="left">描述</th>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("api_path")%></td>
    <td><%# GetOauthType(Eval("is_mobile").ToString())%></td>
    <td><%#Eval("remark")%></td>
