<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms_template_list.aspx.cs" Inherits="CMS.Web.admin.users.sms_template_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="sms_template_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
