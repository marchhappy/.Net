<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment_list.aspx.cs" Inherits="CMS.Web.admin.order.payment_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%# GetPaymentType(Eval("is_mobile").ToString())%></td>
    <td><%#Eval("remark")%></td>
