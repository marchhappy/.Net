<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="CMS.Web.admin.order.order_list" %>
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','只允许删除已作废订单，是否继续？');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
        </ul>
        <div class="menu-list">
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new CMS.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new CMS.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
