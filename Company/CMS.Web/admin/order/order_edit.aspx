<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="CMS.Web.admin.order.order_edit" ValidateRequest="false" %>
...
<script type="text/javascript">
    ...
    function OrderExpress() {
        var winDialog = top.dialog({
            ...
            url: 'dialog/dialog_buyersite.aspx?order_no=' + $("#spanOrderNo").text(),
            width: 450,
            data: window //传入当前窗口
        }).showModal();
    }
  ...
  <dl>
    ...
    <dd>
      <div class="table-container">
        ...
        <tr>
          <th width="20%">支付方式</th>
          <td><%=new CMS.BLL.payment().GetTitle(model.payment_id) %></td>
        </tr>
        <tr>
          <th>配送方式</th>
          <td><%=new CMS.BLL.express().GetTitle(model.express_id) %></td>
        </tr>
        <tr>
          <th>是否开具发票</th>
