<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="CMS.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？</span>
    </dd>
  </dl>
  <dl>
    <dt>短信API地址</dt>
