<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site_edit.aspx.cs" Inherits="CMS.Web.admin.channel.site_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="cbIsMobile" runat="server" />
      </div>
      <span class="Validform_checktip">*移动站点仅适用于移动设备访问。</span>
    </dd>
  </dl>
  <dl>
    <dt>排序数字</dt>
