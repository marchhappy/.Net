<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CMS.Web.Plugin.Feedback.admin.index" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new CMS.BLL.channel_site().GetTitle(Eval("site_path").ToString())%></td>
