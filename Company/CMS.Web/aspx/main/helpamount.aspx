<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMS.Web.UI.Page.mysingle" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n	<script>SysNavnalSet(5);</");
	templateBuilder.Append("script>\r\n	\r\n	\r\n	<div class=\"page-header\">\r\n        <div class=\"container\">\r\n            <div class=\"row\">\r\n                <div class=\"col-md-7\">\r\n                    <h1>帮助信息</h1>\r\n                </div>\r\n                <div class=\"col-md-5\">\r\n                    <ol class=\"breadcrumb pull-right\">\r\n                        <li><a href=\"index.htm\">首页</a></li>\r\n                        <li class=\"active\">帮助信息</li>\r\n                    </ol>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    \r\n    <section class=\"content content-light\">\r\n        <div class=\"container\">\r\n            <div class=\"row\">\r\n                <nav class=\"col-md-3 menu-left\">\r\n                <ul class=\"nav nav-pills nav-stacked\">\r\n					");
	DataTable nlist = get_article_list("news", 57, 8, "status=0", "sort_id desc");

	foreach(DataRow dr in nlist.Rows)
	{

	templateBuilder.Append("\r\n					  <li class=\"haCategory" + Utils.ObjectToStr(dr["id"]) + "\"><a href=\"");
	templateBuilder.Append(linkurl("helpamount",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\">" + Utils.ObjectToStr(dr["title"]) + "</a></li>\r\n					");
	}	//end for if

	templateBuilder.Append("                    \r\n                </ul>\r\n                </nav>\r\n                <section class=\"col-md-9 content-regular-page\">\r\n                    ");
	templateBuilder.Append(getCategoryContext("news", 57, "status=0", "sort_id desc").ToString());

	templateBuilder.Append("\r\n                </section>\r\n				<script>\r\n				$('.haCategory");
	templateBuilder.Append(Utils.ObjectToStr(CurentId));
	templateBuilder.Append("').addClass('active');\r\n				</");
	templateBuilder.Append("script>\r\n            </div>\r\n        </div>        \r\n    </section>            \r\n	\r\n	");
