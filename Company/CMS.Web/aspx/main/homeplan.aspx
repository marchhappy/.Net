<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMS.Web.UI.Page.homeplan" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	CMS.Model.article ptPlan = GetPlan("putong");

	templateBuilder.Append("\r\n				<div class=\"col-md-3\">\r\n                    <article class=\"thumbnail text-center\">\r\n                        <header class=\"bg-dark-img\">\r\n                            <h3 class=\"text-white\">");
	templateBuilder.Append(Utils.ObjectToStr(ptPlan.title));
	templateBuilder.Append("</h3>\r\n                            <p class=\"price-circle price-circle-green center-block\"><span class=\"price-circle-bg\"><span class=\"price-value\">¥");
	templateBuilder.Append(ClearMoney(Utils.ObjectToStr(ptPlan.fields["sell_price"])).ToString());

	templateBuilder.Append("</span><small>年</small></span></p>\r\n                        </header>\r\n						<ul>											\r\n							");
	templateBuilder.Append(Utils.ObjectToStr(ptPlan.content));
	templateBuilder.Append("\r\n							<li class=\"button\"><a href=\"javascript:;\" onclick=\"BuyNow(this,'");
	templateBuilder.Append(Utils.ObjectToStr(ptPlan.id));
	templateBuilder.Append("')\" class=\"btn btn-theme btn-green\">立即购买</a></li>\r\n						</ul>\r\n                    </article>\r\n                </div>\r\n				\r\n				");
	CMS.Model.article zyPlan = GetPlan("zhuanye");

	templateBuilder.Append("\r\n				<div class=\"col-md-3\">\r\n                    <article class=\"thumbnail text-center\">\r\n                        <header class=\"bg-dark-img\">\r\n                            <h3 class=\"text-white\">");
	templateBuilder.Append(Utils.ObjectToStr(zyPlan.title));
	templateBuilder.Append("</h3>\r\n                            <p class=\"price-circle price-circle-orange center-block\"><span class=\"price-circle-bg\"><span class=\"price-value\">¥");
	templateBuilder.Append(ClearMoney(Utils.ObjectToStr(zyPlan.fields["sell_price"])).ToString());

	templateBuilder.Append("</span><small>年</small></span></p>\r\n                        </header>\r\n						<ul>											\r\n							");
	templateBuilder.Append(Utils.ObjectToStr(zyPlan.content));
	templateBuilder.Append("\r\n							<li class=\"button\"><a href=\"javascript:;\" onclick=\"BuyNow(this,'");
	templateBuilder.Append(Utils.ObjectToStr(zyPlan.id));
