...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	foreach(CMS.Model.article_attach modelt in model.attach)
	{
	...
	templateBuilder.Append("\r\n                 下载：<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	...
	templateBuilder.Append(Utils.ObjectToStr(modelt.point));
	templateBuilder.Append("分</i></p>\r\n              </div>\r\n            </a>\r\n          </li>\r\n          ");
	}	//end for if

	}	//end for if

	templateBuilder.Append("\r\n        </ul>\r\n      </div>\r\n      <!--附件下载-->\r\n      \r\n      <!--相关资源-->\r\n      <div class=\"section\">\r\n        <h1>相关资源</h1>\r\n      </div>\r\n      <div>\r\n        <ul class=\"list listview\">\r\n          ");
	DataTable redList = get_article_list(channel, model.category_id, 5, "status=0 and is_red=1 and id<>"+model.id);
