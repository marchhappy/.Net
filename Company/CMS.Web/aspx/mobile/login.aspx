...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" data-ignore=\"true\">用户注册</a>\r\n      </div>\r\n      <input id=\"turl\" name=\"turl\" type=\"hidden\" value=\"");
	templateBuilder.Append(Utils.ObjectToStr(turl));
	templateBuilder.Append("\" />\r\n      <div class=\"oauth-list\">\r\n        <h2>合作网站登录</h2>\r\n        ");
	DataTable oauth_list = get_oauth_app_list(0, "is_mobile=0 or is_mobile=2");
	...
	templateBuilder.Append("\r\n        <a href=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("api/oauth/" + Utils.ObjectToStr(dr["api_path"]) + "/index.aspx\" data-ignore=\"true\"><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" /></a>\r\n        ");
	}	//end for if
