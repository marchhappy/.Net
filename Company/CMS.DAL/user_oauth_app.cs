...
namespace CMS.DAL
{
    ...
    public partial class user_oauth_app
    {
        ...
        public int Add(Model.user_oauth_app model)
        {
            ...
            strSql.Append("title,img_url,app_id,app_key,remark,sort_id,is_mobile,is_lock,api_path)");
            ...
            parameters[6].Value = model.is_mobile;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id,title,img_url,app_id,app_key,remark,sort_id,is_mobile,is_lock,api_path");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,img_url,app_id,app_key,remark,sort_id,is_mobile,is_lock,api_path ");
            strSql.Append(" FROM " + databaseprefix + "user_oauth_app ");
            if (strWhere.Trim() != "")
            {
